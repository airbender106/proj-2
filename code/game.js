...
var actorChars = {
  "@": Player,
  "o": Door, // A coin will wobble up and down
  "=": Lava, "|": Lava, "v": Lava,
  //Original interactive element (speed boost)
  "$": Acid,
};
...
var wobbleSpeed = 11, wobbleDist = 0.09;
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if (type == "teleporter") {
    this.player.pos = new Vector (33,4);
    this.actors = this.actors.filter(function(other) {
      return other != actor;
    });
  }
